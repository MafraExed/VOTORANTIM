...
sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_FERI_SOL/Y5GL_FERI_SOL/model/formatter"
], function(BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
	"use strict";
	return BaseController.extend("Y5GL_FERI_SOL.Y5GL_FERI_SOL.controller.Master", {
		formatter: formatter,
		onInit: function() {
			// Control state model
		...
		/**
		 *@memberOf Y5GL_FERI_SOL.Y5GL_FERI_SOL.controller.Master
		 */
	});
});