sap.ui.define([
	...
	return Controller.extend("portal.y5vp_audito_iv.controller.Default", {
		...
		onBeforeRebindTable: function (oEvent) {
			...
			var newFilter1 = new sap.ui.model.Filter("Tipoinv", sap.ui.model.FilterOperator.EQ, sVariant1);
