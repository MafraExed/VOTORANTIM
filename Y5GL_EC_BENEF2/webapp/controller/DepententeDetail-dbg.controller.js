sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_BENEF2.Y5GL_EC_BENEF2.controller.DepententeDetail", {
		formatter: formatter,
		/**
		...
		_onAdd: function (oEvent) {
			...
			var plan = oEvent.getParameter("arguments").Plan;

			if (plan == "CNUN" || plan == "BRAD") {
		...
		onSave: function () {
			...
			if (oEntry.Mothe === "") {
				...
				sap.m.MessageBox.error("Informe o nome da mãe.");
				return;
			} else {
