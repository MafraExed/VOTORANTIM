	...
	return BaseController.extend("Y5GL_DECLAR.Y5GL_DECLAR.controller.Master", {
			...
			AbreDialogSave: function () {
				...
				if (!that._valueHelpDialog1) {
					that._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_DECLAR.Y5GL_DECLAR.view.Declaracoes", that);
			...
			AbreDialogTreinamento: function () {
				...
				if (!that._valueHelpDialog2) {
					that._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_DECLAR.Y5GL_DECLAR.view.Treinamentos", that);
			...
			formatterIcon: function (e) {
				var sRootPath = jQuery.sap.getModulePath("Y5GL_DECLAR.Y5GL_DECLAR");
