...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_DECLAR/Y5GL_DECLAR/test/integration/MasterJourney",
		"Y5GL_DECLAR/Y5GL_DECLAR/test/integration/NavigationJourney",
		"Y5GL_DECLAR/Y5GL_DECLAR/test/integration/NotFoundJourney",
		"Y5GL_DECLAR/Y5GL_DECLAR/test/integration/BusyJourney",
		"Y5GL_DECLAR/Y5GL_DECLAR/test/integration/FLPIntegrationJourney"
	], function () {
		QUnit.start();
	});
});