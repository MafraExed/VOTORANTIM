sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZCBMM_GERAR_COTACAO.ZCBMM_GERAR_COTACAO.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZCBMM_GERAR_COTACAO.ZCBMM_GERAR_COTACAO.controller.ListSelector
			 */
			 ...
			 * @return {ZCBMM_GERAR_COTACAO.ZCBMM_GERAR_COTACAO.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
