sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_RECIBOS4/Y5GL_RECIBOS4/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_RECIBOS4.Y5GL_RECIBOS4.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_RECIBOS4/Y5GL_RECIBOS4/localService/mockserver"], function (mockserver) {
