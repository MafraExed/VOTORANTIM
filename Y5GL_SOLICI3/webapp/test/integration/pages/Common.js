sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_SOLICI3/Y5GL_SOLICI3/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_SOLICI3.Y5GL_SOLICI3.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_SOLICI3/Y5GL_SOLICI3/localService/mockserver"], function (mockserver) {
