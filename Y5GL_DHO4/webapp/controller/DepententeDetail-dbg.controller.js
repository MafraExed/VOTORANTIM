sap.ui.define([
	...
	return BaseController.extend("Y5GL_DHO4.Y5GL_DHO4.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_DHO4.Y5GL_DHO4.view.DepententeDetail
		 */
		onInit: function () {
		...
		onSave: function () {
			...
			var Key = "/ZET_GLRH_DEPENDENTESSet(Pernr='" + Pernr + "',Subty='" + Subty + "',Objps='" + Objps + "',Favor='" + Favor +
				"',Tipo='D',Icnum='" + Cpf + "',Chamado='" + chamado + "')";
			var oEntry = {};
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_DHO4.Y5GL_DHO4.view.LocNascimento", this);
