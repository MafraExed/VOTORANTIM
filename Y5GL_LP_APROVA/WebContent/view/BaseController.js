...
sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ui/core/routing/History", "vsa/y5gl_lp_portal/model/formatter"], function (Controller,
  History, formatter) {
  "use strict";

  return Controller.extend("vsa.y5gl_lp_portal.view.BaseController", {
    ...
    setUser: function (sUserId) {
      ...
      if (sUserId == "") {
        this._oList.bindItems({
          ...
          parameters: {
            expand: "ToAprovadores,ToItems,ToPromoSet,ToPromoCliSet,ToPromoEscSet,ToPromoMixSet,ToPromoSkuSet"
          }
        });
      } else {
        this._oList.bindItems({
        ...
        success: function (oData, response) {
          if (oData.results.length > 0) {
            if (oData.results[0].EAdm && oData.results[0].EAdm != "") {
              ...
              if (!t._oDialogAdm) {
                t._oDialogAdm = sap.ui.xmlfragment("vsa.y5gl_lp_portal.view.fragment.adm", t);
              ...
              if (oData.results[0].ESub && oData.results[0].ESub != "") {
                ...
                // T3RODRIGODC - INÍCIO - INC0395553 - Delegações problema nas aprovações //
                sUserId = oData.results[0].Userid;
                // T3RODRIGODC - FIM - INC0395553 - Delegações problema nas aprovações //
    ...
    setComentario: function (sPath, sLblni, sUnidade) {
      var t = this;
      var sText = "";
      this.getOwnerComponent().getModel().read("/Comentarios", { // COMENTÁRIOS
        async: true,
        filters: [new sap.ui.model.Filter("Dmkey", "EQ", sLblni),
        ...
        success: function (oData, response) {
          ...
          //t.getOwnerComponent().getModel("global").setProperty("/" + sLblni, sText);
        ...
        oIconTabBar.bindAggregation("items", sPathToAprova, function (index, context) {
          ...
          if (context.getObject().Status != "A") {
            return new sap.m.IconTabFilter({
              ...
              //content : new sap.m.Text({text: t.getOwnerComponent().getModel("global").getProperty("/" + context.getObject().Lblni)})
            ...
            var fil = new sap.ui.model.Filter({
              filters: [new sap.ui.model.Filter("IUnidade", "EQ", context.getObject().Unidade),
                ...
                new sap.ui.model.Filter("IProcesso", "EQ", "LP"),
