sap.ui.define([
	...
	return BaseObject.extend("vsa.y5gl_lp_portal.model.GroupSortState", {
		 ...
		 * @alias vsa.y5gl_lp_portal.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "Valor") {
				...
				this._oViewModel.setProperty("/sortBy", "Name1");
			}
