sap.ui.define([
  ...
  return BaseObject.extend("com.sap.build.standard.operadorLogistico.model.NFItemModel", {
  			...
  			setBalance: function(vBalance){
  				this.balance = vBalance.toFixed(3);
  			},
  			...
  			setDescProd: function(vDescProd){
  				this.descProd = vDescProd;
  			},
  			setMaktxLongo: function(vMaktxLongo){
  				this.MaktxLongo = vMaktxLongo;
  			},
  			setXchpf: function(vXchpf){
  				this.xchpf = vXchpf;
  			},
