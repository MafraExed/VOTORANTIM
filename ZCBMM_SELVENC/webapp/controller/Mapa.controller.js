sap.ui.define([
	...
	return BaseController.extend("ZCBMM_SEL_VENCEDOR.ZCBMM_SEL_VENCEDOR.controller.Mapa", {
		...
		OnZterm: function(oEvent) {
			...
			this._valueHelpDialog2 = sap.ui.xmlfragment("ZCBMM_SEL_VENCEDOR.ZCBMM_SEL_VENCEDOR.view.Zterm", this);
