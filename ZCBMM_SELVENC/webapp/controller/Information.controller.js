...
sap.ui.define([
	...
	return BaseController.extend("ZCBMM_SEL_VENCEDOR.ZCBMM_SEL_VENCEDOR.controller.Information", {
		...
		_onObjectMatched: function(oEvent) {
			...
			if (Carteira === "SERVIÇO") {
				...
				this.getView().byId("Filter07").setVisible(false);
			...
			if (Carteira === "INSUMO" || Carteira === "RESIDUO" || Carteira === "BAUXITA") {
				...
				this.getView().byId("Filter07").setVisible(true);
				// Campos não necessarios em MRO
				this.getView().byId("FIdAlturaEmb").setVisible(true);
				this.getView().byId("FIdLarguraEmb").setVisible(true);
		...
		_onBindingChange: function() {
			...
			sRoute.setStartAddress(sStart);
			sRoute.setEndAddress(sEnd);
		},
