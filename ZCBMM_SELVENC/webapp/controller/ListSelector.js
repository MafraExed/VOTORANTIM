sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZCBMM_SEL_VENCEDOR.ZCBMM_SEL_VENCEDOR.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZCBMM_SEL_VENCEDOR.ZCBMM_SEL_VENCEDOR.controller.ListSelector
			 */
			 ...
			 * @return {ZCBMM_SEL_VENCEDOR.ZCBMM_SEL_VENCEDOR.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
