sap.ui.define([
	...
	return BaseController.extend("Y5GL_FINANCEIR2.Y5GL_FINANCEIR2.controller.BENEFICIOS_DETAIL", {
		...
		onSave: function (via2)  {
			...
			case "REFEITORIO":
				...
				break;
			case "REEMBOLSO_ESTACIONAM":
				oEntry.Valor = this.getView().byId("ESTACIONAMENTO").getValue();
				if (oEntry.Valor === "") {
		...
		_onBindingChange: function () {
			...
			case "REEMBOLSO_EXT_UNIV":
				...
				// this.getView().byId("IdEditDetailDep").setText("Solicitar");
				 ...
				 oFilterPernr = new sap.ui.model.Filter("Pernr", sap.ui.model.FilterOperator.EQ, Pernr);
			...
			case "PREV_PRIV_SUP":
				...
				break;
			case "REEMBOLSO_ESTACIONAM":
				 valor1 = this.getView().byId("ESTACIONAMENTO").getValue();
				 valor = valor1;
				valor = valor.split("_");
				 mes1 = valor[0];
				 ano1 = valor[1];
		...
		onuploadComplete: function (oEvent) {
			...
			case "REEMBOLSO_ESTACIONAM":
				infty = "XXXX";
				subty = "REES";
				Valor = this.getView().byId("ESTACIONAMENTO").getValue();
				break;
			case "REEMBOLSO_EDUCACAO":
				infty = "XXXX";
				subty = "REED";
