sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_FINANCEIR2/Y5GL_FINANCEIR2/model/formatter",
	"sap/m/Button",
	"sap/m/Dialog",
	"sap/m/Text",
	"sap/m/Label",
	...
	return BaseController.extend("Y5GL_FINANCEIR2.Y5GL_FINANCEIR2.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_FINANCEIR2.Y5GL_FINANCEIR2.view.DepententeDetail
		 */
		onInit: function () {
			this.getRouter().getRoute("DependenteDetail").attachPatternMatched(this._onObjectMatched, this);

			// Image loading
			var sRootPath = jQuery.sap.getModulePath("Y5GL_FINANCEIR2.Y5GL_FINANCEIR2");
		...
		onSave: function () {
			...
			var Saled = this.getView().byId("IdFormSalEducacao").getValue();
			if (Saled === "N" || Saled === "") {
				Saled = "";
			} else {
				Saled = "X";
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_FINANCEIR2.Y5GL_FINANCEIR2.view.LocNascimento", this);
