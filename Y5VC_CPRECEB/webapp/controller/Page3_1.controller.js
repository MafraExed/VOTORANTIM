sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.operadorLogistico.controller.Page3_1", {
		...
		onInit: function () {
			...
			this.oRouter.getTarget("Page3_1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "Fiori_ListReport_ListReport_0-content-Fiori_ListReport_Table-1-wom5zch4bdygcv09mudcajlh2_S2",
				"groups": ["items"]
			}];
