...
sap.ui.define(['sap/ui/core/mvc/Controller', 'com/innova/sitrack/lib/searchHelp/searchHelp'],
/**
 * Module dependencies
 *
 * @param {typeof sap.ui.core.mvc.Controller} Controller
 */
function (Controller, searchHelp) {
  return (
    /**
     * @class
     ...
     * @constructor
     * @public
     * @namespace com.innova.sitrack.controller.BaseController
     *
    ...
    Controller.extend('com.innova.sili.controller.BaseController', {
       ...
       * @version 0.5.0
       */
      onNavBackTable: function onNavBackTable() {
        this.getModel('appView').setProperty('/backFromButton', true);
        this.getOwnerComponent().onNavBack();
      },
