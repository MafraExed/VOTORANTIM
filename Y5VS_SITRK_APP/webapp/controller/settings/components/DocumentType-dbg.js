  ...
  return {
    ...
    handleOpenDocumentTypeDialog: function handleOpenDocumentTypeDialog(oSelectedObject) {
      ...
      this._oDocumentTypeDialog = sap.ui.core.Fragment.load({
        name: 'com.innova.sitrack.view.settings.fragment.CreateDocumentType',
        controller: this
    ...
    _saveOrUpdateDocumentType: function _saveOrUpdateDocumentType(oPayload) {
      petitions.post(constant.GET_CONF_DOCS, {
        IT_DOCS: [oPayload]
      }).then(this.getDocumentTypes.bind(this)).then(this.handleCloseDocumentTypeDialog.bind(this)).then(this.clearSelectedIndex.bind(this)).catch(this.errorHandler.bind(this));
    }
    /* =========================================================== */
