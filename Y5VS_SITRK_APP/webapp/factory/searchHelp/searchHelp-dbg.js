...
sap.ui.define(['./utils/index', 'com/innova/formatter/maxLength', 'sap/m/Column', 'sap/m/ColumnListItem', 'sap/m/Input', 'sap/m/Text'], function (utils, maxLength, Column, ColumnListItem, Input, Text) {
  var factory = {
    /**
     * @function
     ...
     * @returns {sap.m.ColumnListItem} - No retorna nada.
     *
     * @author Edwin Valencia <evalencia@innovainternacional.biz>
     * @version 0.5.0
     */
     ...
     *
     * @private
     * @param {string} sId - Id del elemento
     * @param {sap.ui.model.Context} - Contexto del objeto a agregar.
     * @returns {sap.m.ColumnListItem} - ColumnListItem para la agregaciÃ³n de los items de la sap.m.Table.
     *
     * @author Edwin Valencia <evalencia@innovainternacional.biz>
     * @version 0.5.0
     */
