sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_EC_RECESSO/Y5GL_EC_RECESSO/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_EC_RECESSO.Y5GL_EC_RECESSO.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_EC_RECESSO/Y5GL_EC_RECESSO/localService/mockserver"], function (mockserver) {
