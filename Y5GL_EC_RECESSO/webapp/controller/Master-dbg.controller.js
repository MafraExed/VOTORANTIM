sap.ui.define(["Y5GL_EC_RECESSO/Y5GL_EC_RECESSO/controller/BaseController", "sap/ui/model/json/JSONModel", "sap/ui/core/routing/History",
	"sap/ui/model/Filter", "sap/ui/model/Sorter", "sap/ui/model/FilterOperator", "sap/m/GroupHeaderListItem", "sap/ui/Device",
	"Y5GL_EC_RECESSO/Y5GL_EC_RECESSO/model/formatter"
], function (e, t, r, o, i, n, a, s, d) {
	"use strict";
	return e.extend("Y5GL_EC_RECESSO.Y5GL_EC_RECESSO.controller.Master", {
		formatter: d,
		onInit: function () {
		...
		formatterIcon: function (e) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_EC_RECESSO.Y5GL_EC_RECESSO");
