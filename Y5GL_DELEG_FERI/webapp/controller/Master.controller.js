...
sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_DELEG_FERI/Y5GL_DELEG_FERI/model/formatter",
	"sap/m/Dialog",
	"sap/m/Button",
	"sap/m/Text"
	...
	return BaseController.extend("Y5GL_DELEG_FERI.Y5GL_DELEG_FERI.controller.Master", {
		formatter: formatter,
		onInit: function () {
		...
		onRevert: function(){
			...
			var dialog = new Dialog({
				...
				type: "Message",
				content: new Text({
					text: " Confirma a reversão delegação de férias?"
				}),
						...
						oModel.update(key, oEntry, {
							success: function (oData, oResponse) {
								...
								sap.m.MessageBox.success(
									"Reversão da delegação realizada", {
										actions: ["OK"],
