sap.ui.define(["Y5GL_DELEG_FERI/Y5GL_DELEG_FERI/controller/BaseController", "sap/ui/model/json/JSONModel",
	"Y5GL_DELEG_FERI/Y5GL_DELEG_FERI/model/formatter", "sap/ui/Device", "sap/m/Dialog", "sap/m/Button", "sap/m/Text", "sap/ui/core/Fragment",
	...
	return e.extend("Y5GL_DELEG_FERI.Y5GL_DELEG_FERI.controller.DetalheFerias", {
		formatter: a,
		...
		onInit: function () {
			...
			var a = jQuery.sap.getModulePath("Y5GL_DELEG_FERI.Y5GL_DELEG_FERI");
		...
		AbreDialogSave: function () {
			...
			if (!e._valueHelpDialog1) {
				e._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_DELEG_FERI.Y5GL_DELEG_FERI.view.dialog", e);
		...
		AbreDialogCancel: function () {
			...
			if (!e._valueHelpDialog2) {
				e._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_DELEG_FERI.Y5GL_DELEG_FERI.view.dialogCancel", e);
		...
		formatterIcon: function (e) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_DELEG_FERI.Y5GL_DELEG_FERI");
