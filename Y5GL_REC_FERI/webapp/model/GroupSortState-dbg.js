sap.ui.define([
	...
	return BaseObject.extend("Y5GL_REC_FERI.Y5GL_REC_FERI.model.GroupSortState", {
		 ...
		 * @alias Y5GL_REC_FERI.Y5GL_REC_FERI.model.GroupSortState
		 */
		...
		/**
		 * Groups by Index, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "Index") {
				...
				this._oViewModel.setProperty("/sortBy", "Index");
