sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_REC_FERI/Y5GL_REC_FERI/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Y5GL_REC_FERI-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Y5GL_REC_FERI-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("Y5GL_REC_FERI.Y5GL_REC_FERI.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_REC_FERI/Y5GL_REC_FERI/localService/mockserver"], function (mockserver) {
