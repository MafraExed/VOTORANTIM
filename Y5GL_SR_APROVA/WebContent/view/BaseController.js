...
sap.ui.define([ "sap/ui/core/mvc/Controller", "sap/ui/core/routing/History", "vsa/y5gl_sr_portal/model/formatter" ], function(Controller, History, formatter) {
  "use strict";

  return Controller.extend("vsa.y5gl_sr_portal.view.BaseController", {
        ...
        success : function(oData, response) {
          if(oData.results.length > 0){
            if(oData.results[0].EAdm && oData.results[0].EAdm != ""){
              ...
              if (!t._oDialogAdm) {
                t._oDialogAdm = sap.ui.xmlfragment("vsa.y5gl_sr_portal.view.fragment.adm", t);
...
//        });
    ...
    setComentario : function(sPath, sLblni, sUnidade) {
      ...
      this.getOwnerComponent().getModel().read("/Comentarios", { // COMENTÁRIOS
        async : true,
        filters : [ new sap.ui.model.Filter("Lblni", "EQ", sLblni),
        ...
        oIconTabBar.bindAggregation("items", sPathToAprova, function(index, context) {
          ...
          return new sap.m.IconTabFilter({
            ...
            var fil = new sap.ui.model.Filter({ filters: [ new sap.ui.model.Filter("IUnidade", "EQ", context.getObject().Unidade),
                                     new sap.ui.model.Filter("IDocumento", "EQ", context.getObject().Lblni),
                                       new sap.ui.model.Filter("IBukrs", "EQ", context.getObject().Bukrs),
                                     new sap.ui.model.Filter("IProcesso", "EQ", "SR"),
