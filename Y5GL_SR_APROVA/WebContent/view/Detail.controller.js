...
sap.ui.define([
  ...
  return BaseController.extend("vsa.y5gl_sr_portal.view.Detail", {
    ...
    onInit: function () {
      ...
      // detail page is busy indication immediaso there is no break in
      ...
      this.getRouter().getRoute("sSr").attachPatternMatched(this._onObjectMatched, this);
    ...
    _onObjectMatched: function (oEvent) {
        ...
        this._sLblni = oEvent.getParameter("arguments").lblni;
        ...
        this.getModel().metadataLoaded().then(function () {
          var sObjectPathHeader = this.getModel().createKey("Servicos", {
    ...
    onApprove: function (e) {
      if (!this._oDialogApprove) {
        this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_sr_portal.view.fragment.approve", this);
    ...
    onApprove_W: function (e) {
      if (!this._oDialogApprove_W) {
        this._oDialogApprove_W = sap.ui.xmlfragment("vsa.y5gl_sr_portal.view.fragment.approve_w", this);
    ...
    onReject: function (e) {
      ...
      aFilters.push(new Filter("Processo", FilterOperator.EQ, "SR"));
    ...
    _openRejectionPopup: function(){
      if (!this._oDialogReject) {
        this._oDialogReject = sap.ui.xmlfragment(this.getView().getId(),"vsa.y5gl_sr_portal.view.fragment.reject", this);
    ...
    onQuestion : function(e){
      ...
      if (!this._oDialogQuestion) {
        this._oDialogQuestion = sap.ui.xmlfragment("vsa.y5gl_sr_portal.view.fragment.question", this);
    ...
    onInterruption : function(e){
      ...
      if (!this._oDialogInterruption) {
        this._oDialogInterruption = sap.ui.xmlfragment("vsa.y5gl_sr_portal.view.fragment.interrupt", this);
