sap.ui.define([
	...
	return BaseController.extend("Y5GL_CSC2.Y5GL_CSC2.controller.BENEFICIOS_DETAIL", {
		...
		_onObjectMatched: function (oEvent) {
			...
			// T3LUIZFMA - 16/05/2023 - CB.HR: 4065090 - Início
			// Ajuste Aprovacao Odonto CSC
			var oFilterPernrOdonto = new sap.ui.model.Filter("Pernr", sap.ui.model.FilterOperator.EQ, Pernr);
			
			// Plano
			var PlanoOdonto;
			PlanoOdonto = this.getView().byId("IdPlano_PLANO_ODONTOLOGICO").getBinding("items");
			PlanoOdonto.filter([oFilterPernrOdonto]);
			// T3LUIZFMA - 16/05/2023 - CB.HR: 4065090 - Fim
		},
		...
		_onBindingChange: function () {
			...
			case "REEMBOLSO_ESTACIONAM":
				...
				var valor_mes = this.getView().byId("IdPlano_REEMBOLSO_ESTACIONAM").getValue();
				
				this.getView().byId("IdPlano_REEMBOLSO_ESTACIONAM").setValue("");
		...
		onEdit: function () {
			...
			case "TRANSPORTE":
				...
				visao.byId("FormContainer6_TRANSPORTE").setVisible(true);

				var smartTable = this.getView().byId("smartTable_TRANSPORTE");
				smartTable.rebindTable("e");
				break;
			case "VALE_REFEICAO":
