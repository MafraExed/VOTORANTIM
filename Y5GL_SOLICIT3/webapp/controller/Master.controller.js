sap.ui.define([
	...
	return BaseController.extend("Y5GL_SOLICI3.Y5GL_SOLICI3.controller.Master", {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_SOLICI3.Y5GL_SOLICI3.view.ViewSettingsDialog",
					controller: this
		...
		formatIconList: function (oValue, oValue2) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_SOLICI3.Y5GL_SOLICI3");
