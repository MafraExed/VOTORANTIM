		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project02 Worklist Detail",
									"targetURL": "#votorantimproject02wksdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"votorantimproject02wksdetail-display": {
								"semanticObject": "votorantimproject02wksdetail",
								"action": "display",
								"description": "A Fiori application - Project02 Worklist Detail",
								"title": "Project02 Worklist Detail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=votorantim.project02wksdetail",
									"url": sap.ui.require.toUrl("votorantim/project02wksdetail")
								}
							}
						}
					}
