sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_EC_BENEFICIOS/Y5GL_EC_BENEFICIOS/model/formatter",
	"sap/m/Button",
	"sap/m/Dialog",
	"sap/m/Text",
	"sap/m/Label",
	...
	return BaseController.extend("Y5GL_EC_BENEFICIOS.Y5GL_EC_BENEFICIOS.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_EC_CAD2.Y5GL_EC_CAD2.view.DepententeDetail
		 */
		onInit: function () {
		...
		onDeleteSelectedItems: function (oEvent) {
			...
			var Key = "/ZET_GLRH_UPLOADSet(Ano='" + Ano + "',Favor='" + Favor + "',Infty='" + Infty + "',Mes='" + Mes + "',Pernr='" + Pernr +
				"',Tipo='" + Tipo + "',Subty='" + Subty + "',DocId=" + docid + ",Objps='',Icnum='" + cpf + "',Dependentes='',Valor='',Area='')";
