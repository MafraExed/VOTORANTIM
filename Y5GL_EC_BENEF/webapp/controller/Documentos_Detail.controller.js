sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_BENEFICIOS.Y5GL_EC_BENEFICIOS.controller.Documentos_Detail", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_EC_BENEFICIOS.Y5GL_EC_BENEFICIOS.view.Documentos_Detail
		 */
		onInit: function () {
			this.getRouter().getRoute("Documentos_Detail").attachPatternMatched(this._onObjectMatched, this);

			// Image loading
			var sRootPath = jQuery.sap.getModulePath("Y5GL_EC_BENEFICIOS.Y5GL_EC_BENEFICIOS");
