sap.ui.define([
	...
	"Y5GL_SOLICIT4/Y5GL_SOLICIT4/model/formatter"
], function (BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, Fragment, formatter) {
	"use strict";

	return BaseController.extend("Y5GL_SOLICIT4.Y5GL_SOLICIT4.controller.Master", {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_SOLICIT4.Y5GL_SOLICIT4.view.ViewSettingsDialog",
					controller: this
			...
			if (Parameter !== undefined) {
				...
				if (Status !== "Efetivado") {
					if (Status === "Reprovado") {
						...
						sap.m.MessageBox.show("Tu solicitud aún se está procesando.");
						return;
					}
				}

				if (Status === "Efetivado") {
					sap.m.MessageBox.show("Petición aprobada.");
					return;
				}
			}
		},
		...
		formatBeneficio: function (oValue) {
