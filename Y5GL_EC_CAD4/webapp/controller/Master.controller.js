sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_CAD4.Y5GL_EC_CAD4.controller.Master", {
		...
		onUpdateFinished: function (oEvent) {
			var that = this;
			if (init === 1) {
				sap.m.MessageBox.warning("Mantenga sus datos y contacto de referencia siempre actualizados", {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_EC_CAD4.Y5GL_EC_CAD4.view.ViewSettingsDialog",
					controller: this
