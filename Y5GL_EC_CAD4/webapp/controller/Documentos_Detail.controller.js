sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_CAD4.Y5GL_EC_CAD4.controller.Documentos_Detail", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_EC_CAD4.Y5GL_EC_CAD4.view.Documentos_Detail
		 */
		onInit: function () {
		...
		_onBindingChange: function () {
			...
			this.getView().byId("_0015").setVisible(false);
			this.getView().byId("_9006").setVisible(false);
		...
		onSave: function () {
			...
			case "_0002":
				...
				if (oEntry.IdentNr === "") {
					sap.m.MessageBox.error("Numero de documento no informado");
					return;
				}
			...
			case "_0007":
				...
				if (oEntry.MilNr === "") {
					sap.m.MessageBox.error("Numero Certificado no informado");
					return;
				}
				oEntry.MilType = this.getView().byId("idMilType").getValue();
				if (oEntry.MilType === "") {
					sap.m.MessageBox.error("Classe Certificado no informado");
					return;
				}
				oEntry.MilCat = this.getView().byId("idMilCat").getValue();
				if (oEntry.MilCat === "") {
					sap.m.MessageBox.error("Categoria Certificado no informado");
					return;
				}
				oEntry.EsEmis = this.getView().byId("idDtEmis_7").getSelectedKey();
				if (oEntry.MilCat === "") {
					sap.m.MessageBox.error("UF de Expedição no informado");
					return;
				}
				break;
			case "_0008":
				...
				if (oEntry.IdforNr === "") {
					sap.m.MessageBox.error("Numero de identificacion estrajanro no informado");
					return;
				}
			...
			case "_0015":
				...
				break;
			case "_9006":
				oEntry.IdentNr = this.getView().byId("idIdentNr_9006").getValue();
				break;
			}
								...
								sap.m.MessageBox.success(
									"Su inclusión / cambio ha comenzado y se seguirá procesando. Espere comentarios o siga la aplicación.", {
										...
										onClose: function (sAction) {
											...
											that.getRouter().navTo("DOCUMENTOS");   
										}
									});
							},
		...
		onEdit: function () {
			...
			case "_0001":
				...
				break;
			case "_0002":
				sap.m.MessageBox.error("No es posible cambiar el documento.");
				return;
			...
			case "_0015":
				...
				break;
			case "_9006":
				this.getView().byId("idIdentNr_9006").setEditable(true);
				break;
			}
