sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_CAD4.Y5GL_EC_CAD4.controller.DEPENDENTES", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_EC_CAD4.Y5GL_EC_CAD4.view.DEPENDENTES
		 */
		onInit: function () {
		...
		_Confirme_Dependete: function (oEvent) {
			...
			while(Favor.indexOf("%20") != -1){
				Favor = Favor.replace("%20", " ");
			}
		...
		onExcluir: function () {
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_EC_CAD4.Y5GL_EC_CAD4.view.Dependente", this);
