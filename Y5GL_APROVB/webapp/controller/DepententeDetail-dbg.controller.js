sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_APROVB/Y5GL_APROVB/model/formatter",
	"sap/m/Button",
	"sap/m/Dialog",
	"sap/m/Text",
	...
	return BaseController.extend("Y5GL_APROVB.Y5GL_APROVB.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_APROVB.Y5GL_APROVB.view.DepententeDetail
		 */
		onInit: function () {
		...
		onSave: function () {
			...
			var dialog = new Dialog({
				...
				type: "Message",
				content: new Text({
					text: "Confirma a inclusão do dependente?"
				}),
				beginButton: new Button({
					text: "Sim",
					press: function () {
