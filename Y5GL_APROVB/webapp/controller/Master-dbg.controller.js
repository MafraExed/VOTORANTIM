sap.ui.define([
	...
	return BaseController.extend("Y5GL_APROVB.Y5GL_APROVB.controller.Master", {
		...
		onInit : function () {
			...
			oModel.setHeaders({
				"myHeader-1" : "myValue-1",
				"myHeader-2" : "myValue-2"
			})*/
		},
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_APROVB.Y5GL_APROVB.view.ViewSettingsDialog",
					controller: this
