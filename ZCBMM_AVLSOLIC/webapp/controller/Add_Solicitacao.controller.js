sap.ui.define([
	...
	return BaseController.extend("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.controller.Add_Solicitacao", {
		...
		onHelpWerks: function(oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Werks", this);
		...
		onHelpCarteira: function(oEvent) {
			...
			if (!this._valueHelpDialog2) {
				this._valueHelpDialog2 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Carteira", this);
		...
		onHelpPrioridade: function(oEvent) {
			...
			if (!this._valueHelpDialog3) {
				this._valueHelpDialog3 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Prioridade", this);
		...
		onHelpModalidade: function(oEvent) {
			...
			if (!this._valueHelpDialog4) {
				this._valueHelpDialog4 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Modalidade", this);
		...
		onHelpFinalidade: function(oEvent) {
			...
			if (!this._valueHelpDialog5) {
				this._valueHelpDialog5 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Finalidade", this);
		...
		onHelpGrupoDeCompras: function(oEvent) {
			...
			if (!this._valueHelpDialog6) {
				this._valueHelpDialog6 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.GrupoDeCompras", this);
