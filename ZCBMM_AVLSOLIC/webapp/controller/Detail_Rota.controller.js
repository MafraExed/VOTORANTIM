sap.ui.define([
	...
	return BaseController.extend("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.controller.Detail_Rota", {

		onInit: function() {
			this.getRouter().getRoute("Detail_Rota").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		onHelpZone1: function(oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Zone1", this);
		...
		onHelpPerigoso: function(oEvent) {
			...
			if (!this._valueHelpDialog2) {
				this._valueHelpDialog2 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Perigoso", this);
		...
		onHelpTpEmbalagem: function(oEvent) {
			...
			if (!this._valueHelpDialog3) {
				this._valueHelpDialog3 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.TpEmbalagem", this);
		...
		onHelpTpVeiculo: function(oEvent) {
			...
			if (!this._valueHelpDialog4) {
				this._valueHelpDialog4 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.TpVeiculo", this);
		...
		onHelpWerks: function(oEvent) {
			...
			if (!this._valueHelpDialog5) {
				this._valueHelpDialog5 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Werks", this);
		...
		onHelpMaterial: function(oEvent) {
			...
			if (!this._valueHelpDialog6) {
				this._valueHelpDialog6 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Material", this);
		...
		onHelpTpCarreg: function(oEvent) {
			...
			if (!this._valueHelpDialog7) {
				this._valueHelpDialog7 = sap.ui.xmlfragment("ZCBMM_AVLSOLIC.ZCBMM_AVLSOLIC.view.Carregamento", this);
