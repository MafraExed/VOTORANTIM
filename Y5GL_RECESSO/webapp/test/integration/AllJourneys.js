...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_RECESSO/Y5GL_RECESSO/test/integration/MasterJourney",
		"Y5GL_RECESSO/Y5GL_RECESSO/test/integration/NavigationJourney",
		"Y5GL_RECESSO/Y5GL_RECESSO/test/integration/NotFoundJourney",
		"Y5GL_RECESSO/Y5GL_RECESSO/test/integration/BusyJourney"
	], function () {
		QUnit.start();
	});
});