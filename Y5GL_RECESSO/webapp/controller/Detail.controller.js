sap.ui.define(["Y5GL_RECESSO/Y5GL_RECESSO/controller/BaseController", "sap/ui/model/json/JSONModel",
	"Y5GL_RECESSO/Y5GL_RECESSO/model/formatter", "sap/ui/Device", "sap/m/Dialog", "sap/m/Button", "sap/m/Text", "sap/ui/core/Fragment"
], function (e, t, a, i, s, o, r, d) {
	"use strict";
	var n, l, g, u, c, I, h, V, b, f, S;
	return e.extend("Y5GL_RECESSO.Y5GL_RECESSO.controller.Detail", {
		formatter: a,
		...
		onInit: function () {
			...
			var a = jQuery.sap.getModulePath("Y5GL_RECESSO.Y5GL_RECESSO");
		...
		onCancel: function (e, t, a) {
			...
			var f = new s({
				...
				type: "Message",
				content: new r({
					text: "Confirma cancelamento do recesso?"
				}),
				beginButton: new o({
					text: "Sim",
					press: function () {
						...
						b.update(l, g, {
							success: function (e, t) {
								sap.m.MessageBox.success("Seu recesso foi cancelado com sucesso.", {
									actions: ["OK", sap.m.MessageBox.Action.CLOSE],
									onClose: function (e) {
		...
		onSave: function (e, t, a) {
			...
			var d = this.getView().byId("IdIndex").getValue();
			var n = this.getView().byId("IdPernr").getValue();
			var l = "/ZET_GLHR_ESS_FERIASSet(Index=" + d + ",Pernr='" + n + "',Acao='E')";
			var g = {};
			var V = 0;
			var b = this.getView().getModel();
			var peri3 = true;
			...
			if (peri3 === true) {
				...
				g.DiasGozo3 = this.getView().byId("tree_diasgozo").getValue();
				...
				this.getView().byId("tree_diasgozo").setValueState("None");
			...
			var f = new s({
				...
				type: "Message",
				content: new r({
					text: "Deseja enviar a solicitação de recesso?"
				}),
				beginButton: new o({
					text: "Sim",
					press: function () {
						...
						b.update(l, g, {
							success: function (e, t) {
								sap.m.MessageBox.success("Seu recesso foi programado com sucesso.", {
									actions: ["OK", sap.m.MessageBox.Action.CLOSE],
									onClose: function (e) {
										i.getView().getModel().refresh(true);
									}
		...
		somardatatree: function () {
			var e = this;
			var t = this.getView().byId("IdInicio3").getValue();
			var a = this.getView().byId("tree_diasgozo").getValue();
			var i;
			...
			if (i === true) {
				if (a > 0) {
					...
					var r = new sap.ui.model.json.JSONModel;
					var d = {};
					d.vdata2 = this.getView().byId("IdInicio3").getValue();
					d.vdays2 = this.getView().byId("tree_diasgozo").getValue();
					r.loadData(o, null, false, "GET", false, false, null);
					var n = r.oData.d.V_RESULTADO;
				...
				sap.m.MessageBox.error("O valor informado deverá ser um número.", {
					actions: ["OK", sap.m.MessageBox.Action.CLOSE],
					onClose: function (t) {
						e.getView().byId("tree_diasgozo").setValue();
					}
				});
			}
		},
		...
		somardata: function (e, t) {
			...
			i.read(o, {
				...
				error: function () {
					sap.m.MessageToast.show("Recesso não encontrado!");
				}
			});
		},
		...
		validatree   : function (e) {
			var t = this.getView().byId("tree_diasgozo").getValue();
			var a = /^[0-9]+$/;
			if (t.match(a)) {
				if (t.length > 2) {
					var i = t.slice(0, 2);
					this.getView().byId("tree_diasgozo").setValue(i);
				}
				if (t.length < 2) {
					this.somardatatree();
				}
				...
				var s = t.slice(0, 0);
				this.getView().byId("tree_diasgozo").setValue(s);
				this.somardatatree();
			}
		},
		// Validações - Fim
