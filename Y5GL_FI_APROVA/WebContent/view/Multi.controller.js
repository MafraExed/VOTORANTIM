...
sap.ui.define([
		...
		return BaseController.extend("vsa.y5gl_fi_portal.view.Multi", {
			...
			onInit : function () {
				...
				this.getRouter().getRoute("mFi").attachPatternMatched(this._onObjectMatched, this);
			...
			onUpdateFinished: function(oEvent){
				if(oEvent.getParameter("total") > 0){
					this._oTable.setTitle(this.getResourceBundle().getText("TABLETITLE", oEvent.getParameter("total")));
				}else{
			...
			onApprove: function (e) {			
				if (!this._oDialogApprove) {
					this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_fi_portal.view.fragment.approve_m", this);
