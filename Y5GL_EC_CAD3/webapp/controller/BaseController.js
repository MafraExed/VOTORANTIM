sap.ui.define([
	...
	return Controller.extend("Y5GL_EC_CAD3.Y5GL_EC_CAD3.controller.BaseController", {
		/**
		...
		handleChange: function (oEvent) {
			...
			if (!sSelectedKey && sValue) {
				...
				oValidatedComboBox.setValueStateText("Valor inválido!");
