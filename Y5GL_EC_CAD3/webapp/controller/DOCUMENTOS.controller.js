sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_CAD3.Y5GL_EC_CAD3.controller.DOCUMENTOS", {
		onInit: function () {
				...
				beginButton: new Button({
					...
					press: function () {
						...
						if (!that._valueHelpDialog1) {
							that._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_EC_CAD3.Y5GL_EC_CAD3.view.LocNascimento", that);
