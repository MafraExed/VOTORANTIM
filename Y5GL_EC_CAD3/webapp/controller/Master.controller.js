sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_CAD3.Y5GL_EC_CAD3.controller.Master", {
		...
		onUpdateFinished: function (oEvent) {
			var that = this;
			if (init === 1) {
				sap.m.MessageBox.warning("Mantenha seus dados e contato de referência sempre atualizados", {
					actions: ["Continuar navegando"],
					onClose: function (sAction) {
						if (sAction === "Continuar navegando"){
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_EC_CAD3.Y5GL_EC_CAD3.view.ViewSettingsDialog",
					controller: this
		...
		formatterIcon: function (oValue) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_EC_CAD3.Y5GL_EC_CAD3");
			...
			case "FORMAÇÃO EDUCACIONAL":
				...
				return icone;
				break;
			case "PESSOA DE REFERÊNCIA":
				icone = sImagePath + "PESSOA_REFERENCIA.png";
				return icone;
				break;
			}
		},
