sap.ui.define([
	"sap/ui/test/Opa5",
	"Y5GL_FERI_NEXA/Y5GL_FERI_NEXA/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("Y5GL_FERI_NEXA.Y5GL_FERI_NEXA.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "Y5GL_FERI_NEXA.Y5GL_FERI_NEXA",
					async: true
				},
				hash: oOptions.hash,
