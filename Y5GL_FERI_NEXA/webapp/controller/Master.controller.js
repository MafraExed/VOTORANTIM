sap.ui.define([
	...
	return BaseController.extend("Y5GL_FERI_NEXA.Y5GL_FERI_NEXA.controller.Master", {
		...
		onInit: function () {
			...
			this._oGroupFunctions = {
				Index: function (oContext) {
					var iNumber = oContext.getProperty('Index'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_FERI_NEXA.Y5GL_FERI_NEXA.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("Index", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("Index", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
