...
sap.ui.define([
	...
	return BaseController.extend("vsa.y5gl_ga_portal.view.Detail", {
		...
		onInit: function () {
			...
			this.getRouter().getRoute("sGa").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function (oEvent) {
				...
				this._sDmkey = oEvent.getParameter("arguments").dmkey;		
				...
				this.getModel().metadataLoaded().then(function () {
					var sObjectPathHeader = this.getModel().createKey("GestAtivos", {
						Dmkey : this._sDmkey,
		...
		_onBindingChange: function () {
			...
			this.setComentario(sObjectPath, this._sDmkey, this._sUnidade).then(function(){
		...
		onApprove: function (e) {			
			if (!this._oDialogApprove) {
				this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_ga_portal.view.fragment.approve", this);
		...
		onApprove_W: function (e) {			
			if (!this._oDialogApprove_W) {
				this._oDialogApprove_W = sap.ui.xmlfragment("vsa.y5gl_ga_portal.view.fragment.approve_w", this);
		...
		onQuestion : function(e){
			...
			if (!this._oDialogQuestion) {
				this._oDialogQuestion = sap.ui.xmlfragment("vsa.y5gl_ga_portal.view.fragment.question", this);
		...
		onInterruption : function(e){
			...
			if (!this._oDialogInterruption) {
				this._oDialogInterruption = sap.ui.xmlfragment("vsa.y5gl_ga_portal.view.fragment.interrupt", this);
