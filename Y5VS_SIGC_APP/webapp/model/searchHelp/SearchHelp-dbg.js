 ...
 *
 * @namespace
 * @name com.innova.sigc.model.searchHelp.SearchHelp
 * @public
 */
...
sap.ui.define(['../item/FormItem', '../item/OptionType', 'com/innova/vendor/lodash.get', 'sap/ui/base/Object'], function (FormItem, OptionType, get, Object) {
  return (
     ...
     *
     * @public
     * @alias com.innova.sigc.model.searchHelp.SearchHelp
     */
    Object.extend('com.innova.sigc.model.searchHelp.SearchHelp', {
      // constructor({ fieldname, ...args }) {
      constructor: function constructor(fieldname, oData) {
        this.IR_FCODE1 = get(oData, 'FCODE1', []);
        this.IR_FCODE2 = get(oData, 'FCODE2', []);
        ...
        this.IV_FCAT = get(oData, 'FCAT', '');
        this.IV_FIELDNAME = fieldname;
        this.IV_ONLYFCAT = get(oData, 'IvOnlyfcat', '');
        this.IV_ROWS = get(oData, 'IvRows', 100);
        this.IV_SPRAS = 'S';
        this.IV_TABNAME = get(oData, 'Tabname', 'ZSTMM_SIGC_INPUTPARAMS');
      },
