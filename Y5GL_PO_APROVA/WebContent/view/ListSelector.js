sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("vsa.y5gl_po_portal.view.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias vsa.y5gl_po_portal.controller.ListSelector
			 */
			 ...
			 * @return {vsa.y5gl_po_portal.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
