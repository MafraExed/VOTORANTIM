...
sap.ui.define([
  ...
  return BaseController.extend("vsa.y5gl_po_portal.view.Detail", {
    ...
    onInit: function () {
      ...
      this.getRouter().getRoute("sPo").attachPatternMatched(this._onObjectMatched, this);
    ...
    _onObjectMatched: function (oEvent) {
        ...
        this.getModel().metadataLoaded().then(function () {
          var sObjectPathHeader = this.getModel().createKey("Pedidos", {
...
//        icon : { path: 'Flaglib', formatter : formatter.iconTabBar } ,
//        iconColor : { path: 'Flaglib', formatter : formatter.colorTabBar },
//        count : { path: 'Relcode' },
//        text : { path: 'NameUsr' }
//      });
//
//      this._oIconTabBar.bindAggregation("items", sObjectPath + "/ToAprovadores", oTemplate );
...
//            oBtn.attachPress(function(e){
//              that.oMP.toggle(e.getSource())
//            }.bind(that.oMP))
    ...
    onApprove: function (e) {
      if (!this._oDialogApprove) {
        this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_po_portal.view.fragment.approve", this);
    ...
    onApprove_W: function (e) {
      if (!this._oDialogApprove_W) {
        this._oDialogApprove_W = sap.ui.xmlfragment("vsa.y5gl_po_portal.view.fragment.approve_w", this);
    ...
    onQuestion : function(e){
      ...
      if (!this._oDialogQuestion) {
        this._oDialogQuestion = sap.ui.xmlfragment("vsa.y5gl_po_portal.view.fragment.question", this);
    ...
    onInterruption : function(e){
      ...
      if (!this._oDialogInterruption) {
        this._oDialogInterruption = sap.ui.xmlfragment("vsa.y5gl_po_portal.view.fragment.interrupt", this);
