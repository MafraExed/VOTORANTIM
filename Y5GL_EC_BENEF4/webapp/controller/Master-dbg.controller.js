sap.ui.define([
	...
	return BaseController.extend("Y5GL_EC_BENEF4.Y5GL_EC_BENEF4.controller.Master", {
		...
		formatIconList: function (oValue) {
            ...
            if (oValue === "ADELANTO" ||
                oValue === "ADELANTO_SUELDOS" ||
                oValue === "ASIGNACION" ||
                oValue === "AGUINALDO_NAVIDENO") {
                icone = sImagePath + "PPRRV.png";
                return icone;
            }

			if (oValue === "ESTAC_MOVBUS") {
			...
			if (oValue === "REEMBOLSO_CURSOS" ||
                oValue === "ASIGNACION_ESCOLAR" || 
                oValue === "PASAJE_UNIVERSITARIO") {
				icone = sImagePath + "FORMACAO.png";
				return icone;
			}

			if (oValue === "REEMBOLSO_EXPATRIADO") {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Y5GL_EC_BENEF4.Y5GL_EC_BENEF4.view.ViewSettingsDialog",
					controller: this
		...
		onSelectionChange: function (oEvent) {
			...
			if (Parameter !== undefined) {
				...
				while(ZdescNew.indexOf("/") != -1){
					ZdescNew = ZdescNew.replace("/", "_");
				}
