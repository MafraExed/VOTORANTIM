...
sap.ui.define([
	...
	return BaseController.extend("Y5GL_CSC4.Y5GL_CSC4.controller.Worklist", {
		...
		onEnvia: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_CSC4.Y5GL_CSC4.view.Operador", this);
		...
		onHelpChamado: function (oEvent) {
			...
			// create value help dialog
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_CSC4.Y5GL_CSC4.view.Chamado", this);
				this.getView().addDependent(this._valueHelpDialog1);
			}
			// open value help dialog filtered by the input value
		...
		onHelpMatriculas: function (oEvent) {
			...
			if (!this._valueHelpDialog2) {
				this._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_CSC4.Y5GL_CSC4.view.Pernr", this);
		...
		onHelpProcesso: function (oEvent) {
			...
			if (!this._valueHelpDialog3) {
				this._valueHelpDialog3 = sap.ui.xmlfragment("Y5GL_CSC4.Y5GL_CSC4.view.Processo", this);
		...
		onHelpStatus: function (oEvent) {
			...
			if (!this._valueHelpDialog4) {
				this._valueHelpDialog4 = sap.ui.xmlfragment("Y5GL_CSC4.Y5GL_CSC4.view.Status", this);
		...
		onHelpDtCriacao: function (oEvent) {
			...
			if (!this._valueHelpDialog5) {
				this._valueHelpDialog5 = sap.ui.xmlfragment("Y5GL_CSC4.Y5GL_CSC4.view.DtCriacao", this);
