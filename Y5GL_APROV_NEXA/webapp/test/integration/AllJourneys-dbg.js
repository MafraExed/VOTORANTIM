...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_APROV_NEXA/Y5GL_APROV_NEXA/test/integration/MasterJourney",
		"Y5GL_APROV_NEXA/Y5GL_APROV_NEXA/test/integration/NavigationJourney",
		"Y5GL_APROV_NEXA/Y5GL_APROV_NEXA/test/integration/NotFoundJourney",
		"Y5GL_APROV_NEXA/Y5GL_APROV_NEXA/test/integration/BusyJourney"
	], function () {
		QUnit.start();
	});
});