sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_APROV_NEXA/Y5GL_APROV_NEXA/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_APROV_NEXA.Y5GL_APROV_NEXA.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_APROV_NEXA/Y5GL_APROV_NEXA/localService/mockserver"], function (mockserver) {
