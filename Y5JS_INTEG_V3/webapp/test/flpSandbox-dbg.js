					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JS Integração Unico",
									"targetURL": "#y5jsintegv3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"y5jsintegv3-display": {
								"semanticObject": "y5jsintegv3",
								"action": "display",
								"description": "Aplicação Fiori para envio de cargo e posição para a Unico",
								"title": "JS Integração Unico",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=y5jsintegv3",
									"url": sap.ui.require.toUrl("y5jsintegv3")
								}
							}
						}
					}
