sap.ui.define([
	...
	return Controller.extend("Y5GL_CADASTRO.Y5GL_CADASTRO.controller.DADOS_PESSOAIS", {
		onInit: function () {
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_CADASTRO.Y5GL_CADASTRO.view.LocNascimento", this);
