sap.ui.define([
		...
		"ZCBLE_PR_REM_SAIDA/ZCBLE_PR_REM_SAIDA/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									name: oBindingContext.getProperty("Emissor")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all ZET_CBLE_PR_REM_SAIDASet to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "ZET_CBLE_PR_REM_SAIDASet",
