sap.ui.define(["./BaseController", "sap/ui/model/json/JSONModel", "sap/ui/core/routing/History", "sap/ui/model/Filter",
	...
	"use strict";
	return e.extend("Y5GL_EC_RECIBOS.Y5GL_EC_RECIBOS.controller.Master", {
		formatter: c,
		onInit: function () {
		...
		onOpenViewSettings: function (e) {
			...
			if (!this.byId("viewSettingsDialog")) {
				l.load({
					...
					name: "Y5GL_EC_RECIBOS.Y5GL_EC_RECIBOS.view.ViewSettingsDialog",
					controller: this
				}).then(function (e) {
		...
		formatterIcon: function (e) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_EC_RECIBOS.Y5GL_EC_RECIBOS");
			...
			case "ADIANTAMENTO QUINZENAL":
				...
				break;
			case "FÉRIAS":
				icone = sImagePath + "13_SALARIO.png";
				return icone;
				break;
			case "INFORME DE RENDIMENTOS":
				icone = sImagePath + "INFORME_RENDIMENTO.png";
				return icone;
				break;
			case "PAGAMENTO MENSAL":
				icone = sImagePath + "PAGAMENTO_MENSAL.png";
				return icone;
				break;
			case "13º SALÁRIO":
				icone = sImagePath + "13_SALARIO.png";
