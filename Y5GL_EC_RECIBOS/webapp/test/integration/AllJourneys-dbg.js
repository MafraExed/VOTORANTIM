...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/test/integration/MasterJourney",
		"Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/test/integration/NavigationJourney",
		"Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/test/integration/NotFoundJourney",
		"Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/test/integration/BusyJourney",
		"Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/test/integration/FLPIntegrationJourney"
	], function () {
		QUnit.start();
	});
});