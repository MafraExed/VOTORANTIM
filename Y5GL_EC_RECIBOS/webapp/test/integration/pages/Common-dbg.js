sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#RECIBOS-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#RECIBOS-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("Y5GL_EC_RECIBOS.Y5GL_EC_RECIBOS.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_EC_RECIBOS/Y5GL_EC_RECIBOS/localService/mockserver"], function (mockserver) {
