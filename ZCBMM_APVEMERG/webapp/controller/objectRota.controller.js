sap.ui.define([
		...
		return BaseController.extend("ZCBMM_APVEMERG.ZCBMM_APVEMERG.controller.objectRota", {
			...
			onEditar: function() {
				...
				this.getView().byId("IdPesoTotal").setEditable(true);
				this.getView().byId("IdPerigoso").setEditable(true);
				this.getView().byId("IdLargura").setEditable(true);
				this.getView().byId("IdCompr").setEditable(true);
				...
				this.getView().byId("IdAltura").setEditable(true);
				...
				var dialog = new Dialog({
					...
					beginButton: new Button({
						...
						press: function() {
							...
							oView.byId("IdPesoTotal").setEditable(false);
							oView.byId("IdPerigoso").setEditable(false);
							oView.byId("IdLargura").setEditable(false);
							oView.byId("IdCompr").setEditable(false);
							...
							oView.byId("IdAltura").setEditable(false);
