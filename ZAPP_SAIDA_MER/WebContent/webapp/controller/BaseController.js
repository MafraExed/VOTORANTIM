...
sap.ui.define([
		...
		return Controller.extend("nasa.ui5.saidaMercadoria.controller.BaseController", {
			/**
			...
			onHandleF4Global: function(oDialog, oView, oFragment){
                ...
                if (! oDialog) {
                	oDialog = sap.ui.xmlfragment("nasa.ui5.saidaMercadoria.view.fragments."+oFragment, this);
                }
