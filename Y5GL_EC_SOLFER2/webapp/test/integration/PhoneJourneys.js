...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_EC_SOLFER2/Y5GL_EC_SOLFER2/test/integration/NavigationJourneyPhone",
		"Y5GL_EC_SOLFER2/Y5GL_EC_SOLFER2/test/integration/NotFoundJourneyPhone",
		"Y5GL_EC_SOLFER2/Y5GL_EC_SOLFER2/test/integration/BusyJourneyPhone"
	], function () {
		QUnit.start();
	});
});