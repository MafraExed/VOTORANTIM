sap.ui.define(["Y5GL_EC_SOLFER2/Y5GL_EC_SOLFER2/controller/BaseController", "sap/ui/model/json/JSONModel",
	"Y5GL_EC_SOLFER2/Y5GL_EC_SOLFER2/model/formatter", "sap/ui/Device", "sap/m/Dialog", "sap/m/Button", "sap/m/Text", "sap/ui/core/Fragment"
], function (e, t, a, i, s, o, r, d) {
	"use strict";
	var n, l, g, u, c, I, h, V, b, f, S;
	return e.extend("Y5GL_EC_SOLFER2.Y5GL_EC_SOLFER2.controller.Detail", {
		formatter: a,
		...
		onSave: function (e, t, a) {
			...
			var g = {};
			var u = this.getView().byId("first_abono").getSelected();
			var ab2 = this.getView().byId("second_abono").getSelected();
			var ab3 = this.getView().byId("third_abono").getSelected();
			var c = this.getView().byId("first_13_1").getSelected();
			var I = this.getView().byId("first_13_2").getSelected();
			var h = this.getView().byId("first_13_3").getSelected();
			var V = 0;
			...
			t = true;
			a = true;
			g.Begda = this.getView().byId("Idbegda").getValue();
			g.Endda = this.getView().byId("Idendda").getValue();
			if (e === true) {
				g.Inicio1 = this.getView().byId("IdInicio1").getValue();
				g.DiasGozo1 = this.getView().byId("first_diasgozo").getValue();
				g.Fim1 = this.getView().byId("IdFim1").getValue();
			...
			if (this.getView().byId("second_abono").getSelected() === true){
				cont++;
			}
			if (this.getView().byId("third_abono").getSelected() === true){
				cont++;
			}
			
			if(cont > 1){
				sap.m.MessageToast.show("Selecione o abono em apenas um período");
				return;
			}
			...
			var f = new s({
				...
				beginButton: new o({
					...
					press: function () {
						...
						b.update(l, g, {
							success: function (e, t) {
								sap.m.MessageBox.success("Férias enviadas para aprovação de seu Gestor.", {
									actions: ["OK"],
									onClose: function (e) {
										i.getView().getModel().refresh(true);
									}
