sap.ui.define(["./BaseController", "sap/ui/model/json/JSONModel", "sap/ui/core/routing/History", "sap/ui/model/Filter",
	...
	"use strict";
	return e.extend("Y5GL_RECIBOS3.Y5GL_RECIBOS3.controller.Master", {
		formatter: c,
		onInit: function () {
		...
		onOpenViewSettings: function (e) {
			...
			if (!this.byId("viewSettingsDialog")) {
				l.load({
					...
					name: "Y5GL_RECIBOS3.Y5GL_RECIBOS3.view.ViewSettingsDialog",
					controller: this
				}).then(function (e) {
		...
		formatterIcon: function (e) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_RECIBOS3.Y5GL_RECIBOS3");
