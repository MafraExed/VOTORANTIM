sap.ui.define([
	...
	return Controller.extend("portal.y5vp_audito_sdlp.controller.Default", {
		...
		onBeforeRebindTable: function (oEvent) {
			...
			for (var i = 0; i < sVariant.length; i++) {
				...
				var newFilter = new sap.ui.model.Filter("StatusAtu", sap.ui.model.FilterOperator.EQ, sVariant[i]);
				//filters.push(newFilter);
				mBindingParams.filters.push(newFilter);
			}
			var oSelect1 = oSmtFilter.getControlByKey("FilterRela");
			var sVariant1 = oSelect1.getSelectedKey();
			var newFilter1 = new sap.ui.model.Filter("Tipodoc", sap.ui.model.FilterOperator.EQ, sVariant1);
