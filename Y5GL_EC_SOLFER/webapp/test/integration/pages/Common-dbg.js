sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_EC_SOLFER/Y5GL_EC_SOLFER/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_EC_SOLFER.Y5GL_EC_SOLFER.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_EC_SOLFER/Y5GL_EC_SOLFER/localService/mockserver"], function (mockserver) {
