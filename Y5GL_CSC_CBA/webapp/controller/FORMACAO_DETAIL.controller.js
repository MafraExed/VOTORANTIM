sap.ui.define([
	...
	var type;
	var Pernr;
	return BaseController.extend("Y5GL_CSC_CBA.Y5GL_CSC_CBA.controller.FORMACAO_DETAIL", {
		...
		onSave: function () {
			...
			var Key = "/ZET_GLHR_FORM_EMP_ECSet(Ausbi='" + oEntry.Ausbi + "',Pernr='" + Pernr + "',Slart='" + slart + "',Tipo='G')";
