/*global location */
sap.ui.define([
  "vsa/y5gl_rc_portal/view/BaseController",
  "sap/ui/model/json/JSONModel",
  "vsa/y5gl_rc_portal/model/formatter",
  "sap/ui/model/FilterOperator",
  "sap/ui/model/Filter"
], function (BaseController, JSONModel, formatter, FilterOperator, Filter) {
  "use strict";

  return BaseController.extend("vsa.y5gl_rc_portal.view.Detail", {
    ...
    onInit: function () {
      ...
      this.getRouter().getRoute("sRc").attachPatternMatched(this._onObjectMatched, this);
    ...
    _onObjectMatched: function (oEvent) {
        ...
        this._sBanfn = oEvent.getParameter("arguments").banfn;
        this._sBnfpo = oEvent.getParameter("arguments").bnfpo;
        ...
        this.getModel().metadataLoaded().then(function () {
          var sObjectPathHeader = this.getModel().createKey("Requisicoes", {
    ...
    _onBindingChange: function () {
      ...
      this.setComentario(sObjectPath, this._sBanfn, this._sBnfpo, this._sUnidade);
      ...
      var sPath = oElementBinding.getPath(),
        ...
        if(oObject){
          ...
          var sBanfn = oObject.Banfn,
            sBnfpo = oObject.Bnfpo,
        ...
        oViewModel.setProperty("/shareSendEmailSubject",
          oResourceBundle.getText("shareSendEmailObjectSubject", [sBanfn]));
        oViewModel.setProperty("/shareSendEmailMessage",
          oResourceBundle.getText("shareSendEmailObjectMessage", [sObjectName, sBanfn, location.href]));
    ...
    onApprove: function (e) {
      if (!this._oDialogApprove) {
        this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_rc_portal.view.fragment.approve", this);
    ...
    onApprove_W: function (e) {
      if (!this._oDialogApprove_W) {
        this._oDialogApprove_W = sap.ui.xmlfragment("vsa.y5gl_rc_portal.view.fragment.approve_w", this);
    ...
    onReject: function (e) {
      ...
      aFilters.push(new Filter("Processo", FilterOperator.EQ, "RC"));
    ...
    _openRejectionPopup: function(){
      if (!this._oDialogReject) {
        this._oDialogReject = sap.ui.xmlfragment(this.getView().getId(),"vsa.y5gl_rc_portal.view.fragment.reject", this);
    ...
    onQuestion : function(e){
      ...
      if (!this._oDialogQuestion) {
        this._oDialogQuestion = sap.ui.xmlfragment("vsa.y5gl_rc_portal.view.fragment.question", this);
    ...
    onInterruption : function(e){
      ...
      if (!this._oDialogInterruption) {
        this._oDialogInterruption = sap.ui.xmlfragment("vsa.y5gl_rc_portal.view.fragment.interrupt", this);
