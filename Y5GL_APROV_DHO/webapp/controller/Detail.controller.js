/*global history */
sap.ui.define([
	"Y5GL_APROV_DHO/Y5GL_APROV_DHO/controller/BaseController",
	...
	"sap/ui/Device",
	"Y5GL_APROV_DHO/Y5GL_APROV_DHO/model/formatter"
], function (BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
	"use strict";
	return BaseController.extend("Y5GL_APROV_DHO.Y5GL_APROV_DHO.controller.Detail", {
		formatter: formatter,
		onInit: function () {
		...
		/**
		 *@memberOf Y5GL_APROV_DHO.Y5GL_APROV_DHO.controller.Master
		 */
		formatterIcon: function (e) {
			var sRootPath = jQuery.sap.getModulePath("Y5GL_APROV_DHO.Y5GL_APROV_DHO");
