sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_APROV_DHO/Y5GL_APROV_DHO/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_APROV_DHO.Y5GL_APROV_DHO.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_APROV_DHO/Y5GL_APROV_DHO/localService/mockserver"], function (mockserver) {
