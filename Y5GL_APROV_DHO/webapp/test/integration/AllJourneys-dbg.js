...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_APROV_DHO/Y5GL_APROV_DHO/test/integration/MasterJourney",
		"Y5GL_APROV_DHO/Y5GL_APROV_DHO/test/integration/NavigationJourney",
		"Y5GL_APROV_DHO/Y5GL_APROV_DHO/test/integration/NotFoundJourney",
		"Y5GL_APROV_DHO/Y5GL_APROV_DHO/test/integration/BusyJourney"
	], function () {
		QUnit.start();
	});
});