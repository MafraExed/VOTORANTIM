sap.ui.define([
	...
	return Controller.extend("Workspace.zagrupador.controller.S0", {
		...
		_filtrarInicial: function () {
			...
			// var oFilter = new sap.ui.model.Filter("Tcode", sap.ui.model.FilterOperator.EQ, cStatusInit);
		...
		_handleRouteTypeValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog) {
				this._valueHelpDialog = sap.ui.xmlfragment("Workspace.zagrupador.view.SRota", this);
