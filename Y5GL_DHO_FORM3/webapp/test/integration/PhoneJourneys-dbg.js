...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_DHO_FORM3/Y5GL_DHO_FORM3/test/integration/NavigationJourneyPhone",
		"Y5GL_DHO_FORM3/Y5GL_DHO_FORM3/test/integration/NotFoundJourneyPhone",
		"Y5GL_DHO_FORM3/Y5GL_DHO_FORM3/test/integration/BusyJourneyPhone"
	], function () {
		QUnit.start();
	});
});