...
sap.ui.define([
	...
	return BaseController.extend("Y5GL_DHO_FORM3.Y5GL_DHO_FORM3.controller.Master", {
		...
		formatIconList: function (oValue) {
			...
			if (oValue === "ADELANTO" ||
                oValue === "ADELANTO SUELDOS" || 
                oValue === "ASIGNACION" ||
                oValue === "AGUINALDO NAVIDENO") {
			...
			if (oValue === "REEMBOLSO CURSOS" ||
                oValue === "ASIGNACION ESCOLAR" || 
                oValue === "PASAJE UNIVERSITARIO") {
		...
		formatName: function (oValue){
			...
			if (oValue === "PASAJE UNIVERSITARIO"){
				retorno = "Pasaje Universitario";
			}

			if (oValue === "ASIGNACION ESCOLAR"){
				retorno = "Asignación Escolar";
			}

			if (oValue === "AGUINALDO NAVIDENO"){
