sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_DHO/Y5GL_DHO/model/formatter",
	"sap/m/Button",
	"sap/m/Dialog",
	"sap/m/Text",
	"sap/m/Label",
	...
	return BaseController.extend("Y5GL_DHO.Y5GL_DHO.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_DHO.Y5GL_DHO.view.DepententeDetail
		 */
		onInit: function () {
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_DHO.Y5GL_DHO.view.LocNascimento", this);
