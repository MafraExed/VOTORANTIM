sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_SOLICIT/Y5GL_SOLICIT/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_SOLICIT.Y5GL_SOLICIT.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_SOLICIT/Y5GL_SOLICIT/localService/mockserver"], function (mockserver) {
