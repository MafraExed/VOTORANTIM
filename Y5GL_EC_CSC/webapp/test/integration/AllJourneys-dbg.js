...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_EC_CSC/Y5GL_EC_CSC/test/integration/MasterJourney",
		"Y5GL_EC_CSC/Y5GL_EC_CSC/test/integration/NavigationJourney",
		"Y5GL_EC_CSC/Y5GL_EC_CSC/test/integration/NotFoundJourney",
		"Y5GL_EC_CSC/Y5GL_EC_CSC/test/integration/BusyJourney",
		"Y5GL_EC_CSC/Y5GL_EC_CSC/test/integration/FLPIntegrationJourney"
	], function () {
		QUnit.start();
	});
});