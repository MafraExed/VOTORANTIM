	...
	return BaseController.extend("Y5GL_EC_CSC.Y5GL_EC_CSC.controller.Documentos_Detail", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_EC_CSC.Y5GL_EC_CSC.view.Documentos_Detail
		 */
		onInit: function () {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getView().byId("idTitleDependentes").setText("Documentos");
		...
		onSave: function(){
			...
			var dialog = new Dialog({
				...
				type: "Message",
				content: new Text({
					text: "Confirma a alteração/inclusão de Documentos?"
				}),
