sap.ui.define([
	...
	var type;
	var Pernr;
	return BaseController.extend("Y5GL_EC_CSC.Y5GL_EC_CSC.controller.FORMACAO_DETAIL", {
		...
		_onBindingChange: function () {
			...
			if (Pernr !== "" || Subty !== "") {
				...
				oList.getBinding("items").filter([oFilterInfty, oFilterSubty, oFilterPernr, oFilterTipo]);
			}
		},
		...
		onSave: function () {
			...
			dialog = new Dialog({
				...
				type: "Message",
				content: new Text({
					text: "Confirma a inclusão de formação educacional?"
				}),
