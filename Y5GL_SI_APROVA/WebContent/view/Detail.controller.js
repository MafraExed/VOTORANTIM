...
sap.ui.define([
  ...
  return BaseController.extend("vsa.y5gl_si_portal.view.Detail", {
    ...
    onInit: function () {
      ...
      this.getRouter().getRoute("sSi").attachPatternMatched(this._onObjectMatched, this);
    ...
    _onObjectMatched: function (oEvent) {
        ...
        this._sProcesso = oEvent.getParameter("arguments").processo;
        ...
        this.getModel().metadataLoaded().then(function () {
          var sObjectPathHeader = this.getModel().createKey("Investimentos", {
            Posnr: this._sProcesso,
    ...
    _bindView: function (sObjectPath) {
      ...
      oModel.read(sObjectPath + "/ToItem", {
        async : true,
    ...
    _onBindingChange: function () {
      ...
      if(this.oMP){this.oMP.destroyItems(); this.oMP.destroyHeaderButton(); this.oMP.destroy()}
        ...
        this.getOwnerComponent().getModel().read(sObjectPath + "/ToErro", {
          async : true,
          success : function(oData, response) {
            if(oData.results.length > 0){
      ...
      this.setComentario(sObjectPath, this._sProcesso, this._sUnidade);
    ...
    onApprove: function (e) {
      if (!this._oDialogApprove) {
        this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_si_portal.view.fragment.approve", this);
    ...
    onApprove_W: function (e) {
      if (!this._oDialogApprove_W) {
        this._oDialogApprove_W = sap.ui.xmlfragment("vsa.y5gl_si_portal.view.fragment.approve_w", this);
    ...
    onReject: function (e) {
      ...
      aFilters.push(new Filter("Processo", FilterOperator.EQ, "SI"));
    ...
    _openRejectionPopup: function(){
      if (!this._oDialogReject) {
        this._oDialogReject = sap.ui.xmlfragment(this.getView().getId(),"vsa.y5gl_si_portal.view.fragment.reject", this);
    ...
    onQuestion : function(e){
      ...
      if (!this._oDialogQuestion) {
        this._oDialogQuestion = sap.ui.xmlfragment("vsa.y5gl_si_portal.view.fragment.question", this);
    ...
    onInterruption : function(e){
      ...
      if (!this._oDialogInterruption) {
        this._oDialogInterruption = sap.ui.xmlfragment("vsa.y5gl_si_portal.view.fragment.interrupt", this);
