/*global history */
sap.ui.define([
  "vsa/y5gl_si_portal/view/BaseController",
  "sap/ui/model/json/JSONModel",
  "sap/ui/model/Filter",
  "sap/ui/model/FilterOperator",
  "sap/m/GroupHeaderListItem",
  "sap/ui/Device",
  "vsa/y5gl_si_portal/model/formatter",
  "vsa/y5gl_si_portal/model/grouper",
  "vsa/y5gl_si_portal/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, Formatter, grouper, GroupSortState) {
  "use strict";

  return BaseController.extend("vsa.y5gl_si_portal.view.Master", {
...
//          }
        ...
        if (this._oList.getItems().length > 0){
          ...
          if (this.sName === "sSi") {
            ...
            for (var i = 0; i < aItems.length; i++) {
              ...
              if (oObject.Posnr === this.sProcesso && oObject.Unidade === this.sUnidade) {
    ...
    onSearch: function (oEvent) {
      ...
      for(var i=0; i<aItems.length; i++){
        ...
        if (sQuery && sQuery != "") {
          if (  mItem.Posnr.toUpperCase().indexOf(sQuery.toUpperCase()) !== -1 ||
    ...
    onSemanticFilterPress: function(){
         if (!this._oDialogApprove_S) {
           this._oDialogApprove_S = sap.ui.xmlfragment("AdvancedSearchDialog", "vsa.y5gl_si_portal.view.fragment.advsearch", this);
  ...
  if(!Device.system.phone){;
    ...
    onOpenViewSettings: function () {
      if (!this._oViewSettingsDialog) {
        this._oViewSettingsDialog = sap.ui.xmlfragment("vsa.y5gl_si_portal.view.fragment.filter", this);
...
//          }.bind(this)));
    ...
    _showDetail: function (oItem) {
      ...
      var sProcesso,
        sUnidade = undefined;
      if(oItem){
        sProcesso   = oItem.getBindingContext().getProperty("Posnr");
...
//        sUnidade = this.getRouter().oHashChanger.getHash().substring(15, 19);
    ...
    _showMulti: function (oItem, bInitial) {
      ...
      if (bInitial){
        ...
        this.getRouter().navTo("mSi", {
          processo   : oItem.getBindingContext().getProperty("Posnr"),
