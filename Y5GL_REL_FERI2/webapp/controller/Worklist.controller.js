...
sap.ui.define([
	...
	"Y5GL_REL_FERI2/Y5GL_REL_FERI2/model/formatter",
	"sap/ui/model/Filter",
	...
	return BaseController.extend("Y5GL_REL_FERI2.Y5GL_REL_FERI2.controller.Worklist", {
		...
		onEnvia: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_REL_FERI2.Y5GL_REL_FERI2.view.Operador", this);
		...
		onHelpChamado: function (oEvent) {
			...
			// create value help dialog
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_REL_FERI2.Y5GL_REL_FERI2.view.Chamado", this);
				this.getView().addDependent(this._valueHelpDialog1);
			}
			// open value help dialog filtered by the input value
		...
		onHelpMatriculas: function (oEvent) {
			...
			if (!this._valueHelpDialog2) {
				this._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_REL_FERI2.Y5GL_REL_FERI2.view.Pernr", this);
		...
		onHelpProcesso: function (oEvent) {
			...
			if (!this._valueHelpDialog3) {
				this._valueHelpDialog3 = sap.ui.xmlfragment("Y5GL_REL_FERI2.Y5GL_REL_FERI2.view.Processo", this);
		...
		onHelpStatus: function (oEvent) {
			...
			if (!this._valueHelpDialog4) {
				this._valueHelpDialog4 = sap.ui.xmlfragment("Y5GL_REL_FERI2.Y5GL_REL_FERI2.view.Status", this);
		...
		onHelpDtCriacao: function (oEvent) {
			...
			if (!this._valueHelpDialog5) {
				this._valueHelpDialog5 = sap.ui.xmlfragment("Y5GL_REL_FERI2.Y5GL_REL_FERI2.view.DtCriacao", this);
		...
		onbeforeRebindTable: function (oEvent) {
			...
			if (this.getView().byId("idFerRel").getSelected()) {
			...
			if (this.getView().byId("idFerProg").getSelected()) {
				oEvent.getParameter("bindingParams").filters.push(new sap.ui.model.Filter({
					path: "FerProgApro",
					operator: "EQ",
					value1: "X"
			...
			if (this.getView().byId("idFerAber").getSelected()) {
				oEvent.getParameter("bindingParams").filters.push(new sap.ui.model.Filter({
					path: "FerAberto",
					operator: "EQ",
					value1: "X"
			...
			if (this.getView().byId("idPerAqui").getSelected()) {
				oEvent.getParameter("bindingParams").filters.push(new sap.ui.model.Filter({
					path: "PeriAquiPerd",
					operator: "EQ",
					value1: "X"
			...
			if (this.getView().byId("idNotVenc").getSelected()) {
				oEvent.getParameter("bindingParams").filters.push(new sap.ui.model.Filter({
					path: "NotVencProgFeriComp",
					operator: "EQ",
					value1: "X"
				}));
			}
