sap.ui.define([
	...
	"sap/ui/Device",
	"Y5GL_CSC/Y5GL_CSC/model/formatter",
	"sap/m/Button",
	"sap/m/Dialog",
	"sap/m/Text",
	"sap/m/Label",
	...
	return BaseController.extend("Y5GL_CSC.Y5GL_CSC.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_CSC.Y5GL_CSC.view.DepententeDetail
		 */
		onInit: function () {
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog1) {
				this._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_CSC.Y5GL_CSC.view.LocNascimento", this);
