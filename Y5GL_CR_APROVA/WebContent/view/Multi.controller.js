...
sap.ui.define([
		...
		return BaseController.extend("vsa.y5gl_cr_portal.view.Multi", {
			...
			onInit : function () {
				...
				this.getRouter().getRoute("mCr").attachPatternMatched(this._onObjectMatched, this);
			...
			onApprove: function (e) {			
				if (!this._oDialogApprove) {
					this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_cr_portal.view.fragment.approve_m", this);
			...
			onReject: function (e) {						
				...
				aFilters.push(new Filter("Unidade", FilterOperator.EQ, this._oTable.getBinding("rows").Unidade));
			...
			onConfirmReject : function(e){
				...
				this.onAcao("R", this._oTable.getBinding("rows").oList, sComent);
			},
