...
sap.ui.define([
		...
		return BaseController.extend("vsa.y5gl_mv_portal.view.Multi", {
			...
			onInit : function () {
				...
				this.getRouter().getRoute("mMv").attachPatternMatched(this._onObjectMatched, this);
			...
			onApprove: function (e) {			
				if (!this._oDialogApprove) {
					this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_mv_portal.view.fragment.approve_m", this);
