sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_FERI_APRO2.Y5GL_FERI_APRO2.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/localService/mockserver"], function (mockserver) {
