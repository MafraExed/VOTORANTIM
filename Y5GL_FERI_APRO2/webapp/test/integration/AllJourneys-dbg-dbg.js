...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/test/integration/MasterJourney",
		"Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/test/integration/NavigationJourney",
		"Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/test/integration/NotFoundJourney",
		"Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/test/integration/BusyJourney"
	], function () {
		QUnit.start();
	});
});