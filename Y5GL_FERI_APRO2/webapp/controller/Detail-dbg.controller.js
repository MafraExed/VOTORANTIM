/*global history */
sap.ui.define([
	"Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/controller/BaseController",
	...
	"sap/ui/Device",
	"Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/model/formatter"
], function (BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
	"use strict";
	return BaseController.extend("Y5GL_FERI_APRO2.Y5GL_FERI_APRO2.controller.Detail", {
		formatter: formatter,
		onInit: function () {
		...
		_showDetail: function (oItem) {
			...
			var Limite = oItem.getBindingContext().getProperty("Limite");

			// ABREU - ATOS - 12/07/2022 - CHAMADO - INC0489908 - INICIO
			if (Limite == "") {
				Limite = 'Saldo(0)';
			}
			// ABREU - ATOS - 12/07/2022 - CHAMADO - INC0489908 - FIM
		...
		/**
		 *@memberOf Y5GL_FERI_APRO2.Y5GL_FERI_APRO2.controller.Master
		 */
