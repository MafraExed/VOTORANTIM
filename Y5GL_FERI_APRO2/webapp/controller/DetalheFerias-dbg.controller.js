sap.ui.define(["Y5GL_FERI_APRO2/Y5GL_FERI_APRO2/controller/BaseController", "sap/ui/model/json/JSONModel",
			...
			"use strict";
			var n, l, g, u, c, I, h, V, b, f, S, Pernr, Index, Endda, Begda, sText, Limite;
			return e.extend("Y5GL_FERI_APRO2.Y5GL_FERI_APRO2.controller.DetalheFerias", {
					formatter: a,
					...
					_onObjectMatched: function (e) {
						...
						Limite = e.getParameter("arguments").Limite;
						if (Pernr !== "" && a !== "" && f !== "" && h !== "") {
					...
					AbreDialogSave: function () {
						...
						if (!e._valueHelpDialog1) {
							e._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_FERI_APRO2.Y5GL_FERI_APRO2.view.dialog", e);
					...
					AbreDialogCancel: function () {
						...
						if (!e._valueHelpDialog2) {
							e._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_FERI_APRO2.Y5GL_FERI_APRO2.view.dialogCancel", e);
					...
					onAltera2: function () {
						...
						this.getView().byId("second_abono").setEditable(true);
					...
					onAltera3: function () {
						...
						this.getView().byId("third_abono").setEditable(true);
					...
					onAprova: function (oEvent) {
						...
						onReprova: function (oEvent) {
							...
							save: function (e, t, a, periodo, acao) {
								...
								var g = {};
								var first_abono = this.getView().byId("first_abono").getSelected();
								var second_abono = this.getView().byId("second_abono").getSelected();
								var third_abono = this.getView().byId("third_abono").getSelected();
								var c = this.getView().byId("first_13_1").getSelected();
								var I = this.getView().byId("first_13_2").getSelected();
								var h = this.getView().byId("first_13_3").getSelected();
								var V = 0;
