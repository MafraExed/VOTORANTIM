sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZCBMM_APRVCOTA.ZCBMM_APRVCOTA.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZCBMM_APRVCOTA.ZCBMM_APRVCOTA.controller.ListSelector
			 */
			 ...
			 * @return {ZCBMM_APRVCOTA.ZCBMM_APRVCOTA.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
