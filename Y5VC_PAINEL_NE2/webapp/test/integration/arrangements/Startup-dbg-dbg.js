sap.ui.define([
	"sap/ui/test/Opa5",
	"Y5VC_PAINEL_NE2/Y5VC_PAINEL_NE2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"Y5VC_PAINEL_NE2/Y5VC_PAINEL_NE2/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("Y5VC_PAINEL_NE2.Y5VC_PAINEL_NE2.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "ZET_VCFI_TIT_COBRARSet/" + encodeURIComponent(sObjectId);
