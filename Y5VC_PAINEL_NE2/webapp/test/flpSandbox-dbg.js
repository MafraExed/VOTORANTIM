		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Y5VC_PAINEL_NE2",
									"targetURL": "#Y5VC_PAINEL_NE2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Y5VC_PAINEL_NE2-display": {
								"semanticObject": "Y5VC_PAINEL_NE2",
								"action": "display",
								"description": "Painel de negociação",
								"title": "Y5VC_PAINEL_NE2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Y5VC_PAINEL_NE2.Y5VC_PAINEL_NE2",
									"url": sap.ui.require.toUrl("Y5VC_PAINEL_NE2/Y5VC_PAINEL_NE2")
								}
							}
						}
					}
