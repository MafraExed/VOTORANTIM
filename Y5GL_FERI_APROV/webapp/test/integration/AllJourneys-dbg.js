...
sap.ui.require([
	...
	sap.ui.require([
		"Y5GL_FERI_APROV/Y5GL_FERI_APROV/test/integration/MasterJourney",
		"Y5GL_FERI_APROV/Y5GL_FERI_APROV/test/integration/NavigationJourney",
		"Y5GL_FERI_APROV/Y5GL_FERI_APROV/test/integration/NotFoundJourney",
		"Y5GL_FERI_APROV/Y5GL_FERI_APROV/test/integration/BusyJourney"
	], function () {
		QUnit.start();
	});
});