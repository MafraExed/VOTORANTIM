sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_FERI_APROV/Y5GL_FERI_APROV/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Y5GL_FERI_APROV.Y5GL_FERI_APROV.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_FERI_APROV/Y5GL_FERI_APROV/localService/mockserver"], function (mockserver) {
