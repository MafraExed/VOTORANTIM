sap.ui.define(["Y5GL_FERI_APROV/Y5GL_FERI_APROV/controller/BaseController", "sap/ui/model/json/JSONModel",
	"Y5GL_FERI_APROV/Y5GL_FERI_APROV/model/formatter", "sap/ui/Device", "sap/m/Dialog", "sap/m/Button", "sap/m/Text", "sap/ui/core/Fragment",
	...
	return e.extend("Y5GL_FERI_APROV.Y5GL_FERI_APROV.controller.DetalheFerias", {
		formatter: a,
		...
		onInit: function () {
			...
			var a = jQuery.sap.getModulePath("Y5GL_FERI_APROV.Y5GL_FERI_APROV");
		...
		AbreDialogSave: function () {
			...
			if (!e._valueHelpDialog1) {
				e._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_FERI_APROV.Y5GL_FERI_APROV.view.dialog", e);
		...
		AbreDialogCancel: function () {
			...
			if (!e._valueHelpDialog2) {
				e._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_FERI_APROV.Y5GL_FERI_APROV.view.dialogCancel", e);
		...
		onCancel: function (e, t, a) {
			...
			var z = this.getView().byId("second_abono").getSelected();
		...
		onSave: function (e, t, a) {
			...
			if (u === true && z === true) {
				sap.m.MessageBox.error("Abono solicitado no 1º período.", {
					actions: ["OK"],
					onClose: function (e) {
						i._valueHelpDialog1.close();
					}
