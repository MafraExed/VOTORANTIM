sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZPUI_BCMM_COND.ZPUI_BCMM_COND.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZPUI_BCMM_COND.ZPUI_BCMM_COND.controller.ListSelector
			 */
			 ...
			 * @return {ZPUI_BCMM_COND.ZPUI_BCMM_COND.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
