sap.ui.define([
	...
	return BaseController.extend("ZCBMM_APROVMAP.ZCBMM_APROVMAP.controller.Mapa", {
		...
		OnZterm: function(oEvent) {
			...
			if (!this._valueHelpDialog2) {
				this._valueHelpDialog2 = sap.ui.xmlfragment("ZCBMM_APROVMAP.ZCBMM_APROVMAP.view.Zterm", this);
