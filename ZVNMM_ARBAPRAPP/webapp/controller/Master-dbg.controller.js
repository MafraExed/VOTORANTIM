sap.ui.define([
	...
	return BaseController.extend("zvnmmarbaprapp.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				Amount : function(oContext) {
					var iNumber = oContext.getProperty('Amount'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("PRId", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "zvnmmarbaprapp.view.ViewSettingsDialog",
					controller: this
		...
		_showDetail : function (oItem) {
			...
			this.getRouter().navTo("object", {
				objectId : oItem.getBindingContext().getProperty("PRId")
			}, bReplace);
		},
