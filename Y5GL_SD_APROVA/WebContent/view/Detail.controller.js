/*global location */
sap.ui.define([
  "vsa/y5gl_sd_portal/view/BaseController",
  "sap/ui/model/json/JSONModel",
  "vsa/y5gl_sd_portal/model/formatter",
  "sap/ui/model/FilterOperator",
  "sap/ui/model/Filter"
], function (BaseController, JSONModel, formatter, FilterOperator, Filter) {
  "use strict";

  return BaseController.extend("vsa.y5gl_sd_portal.view.Detail", {
    ...
    onInit: function () {
      ...
      this.getRouter().getRoute("sSd").attachPatternMatched(this._onObjectMatched, this);
    ...
    _onObjectMatched: function (oEvent) {
        ...
        this._sOvkey = oEvent.getParameter("arguments").ovkey;
        ...
        this.getModel().metadataLoaded().then(function () {
          var sObjectPathHeader = this.getModel().createKey("OrdVendas", {
            Ovkey : this._sOvkey,
    ...
    _onBindingChange: function () {
      ...
      // Model para Exibição dos KPI's 
      this.getView().setModel(new sap.ui.model.json.JSONModel(), "KPIView");
      ...
      this.setComentario(sObjectPath, this._sOvkey, this._sUnidade);
    ...
    onApprove: function (e) {
      if (!this._oDialogApprove) {
        this._oDialogApprove = sap.ui.xmlfragment("vsa.y5gl_sd_portal.view.fragment.approve", this);
    ...
    onApprove_W: function (e) {
      if (!this._oDialogApprove_W) {
        this._oDialogApprove_W = sap.ui.xmlfragment("vsa.y5gl_sd_portal.view.fragment.approve_w", this);
    ...
    onReject: function (e) {
      ...
      aFilters.push(new Filter("Processo", FilterOperator.EQ, "SD"));
    ...
    _openRejectionPopup: function(){
      if (!this._oDialogReject) {
        this._oDialogReject = sap.ui.xmlfragment(this.getView().getId(),"vsa.y5gl_sd_portal.view.fragment.reject", this);
    ...
    onQuestion : function(e){
      ...
      if (!this._oDialogQuestion) {
        this._oDialogQuestion = sap.ui.xmlfragment("vsa.y5gl_sd_portal.view.fragment.question", this);
    ...
    onInterruption : function(e){
      ...
      if (!this._oDialogInterruption) {
        this._oDialogInterruption = sap.ui.xmlfragment("vsa.y5gl_sd_portal.view.fragment.interrupt", this);
