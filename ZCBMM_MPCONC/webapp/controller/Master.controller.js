...
sap.ui.define([
		...
		return BaseController.extend("ZCBMM_MPCONC.ZCBMM_MPCONC.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ZCBMM_MPCONC.ZCBMM_MPCONC.view.ViewSettingsDialog", this);
