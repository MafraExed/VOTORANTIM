...
sap.ui.define([
	...
	var TpDec;
	var Pernr;
	return BaseController.extend("Y5GL_DECLARACOES.Y5GL_DECLARACOES.controller.Master", {
			formatter: formatter,
			onInit: function () {
				// Control state model
			...
			AbreDialogSave: function () {
				...
				if (!that._valueHelpDialog1) {
					that._valueHelpDialog1 = sap.ui.xmlfragment("Y5GL_DECLARACOES.Y5GL_DECLARACOES.view.Declaracoes", that);
			...
			AbreDialogTreinamento: function () {
				...
				if (!that._valueHelpDialog2) {
					that._valueHelpDialog2 = sap.ui.xmlfragment("Y5GL_DECLARACOES.Y5GL_DECLARACOES.view.Treinamentos", that);
			...
			formatterIcon: function (e) {
				var sRootPath = jQuery.sap.getModulePath("Y5GL_DECLARACOES.Y5GL_DECLARACOES");
