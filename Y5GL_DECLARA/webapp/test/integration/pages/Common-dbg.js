sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Y5GL_DECLARACOES/Y5GL_DECLARACOES/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Declaracoes-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Declaracoes-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("Y5GL_DECLARACOES.Y5GL_DECLARACOES.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Y5GL_DECLARACOES/Y5GL_DECLARACOES/localService/mockserver"], function (mockserver) {
