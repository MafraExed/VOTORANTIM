...
sap.ui.define([ "sap/ui/core/mvc/Controller", "sap/ui/core/routing/History", "vsa/y5gl_pr_portal/model/formatter" ], function(Controller, History, formatter) {
  "use strict";

  return Controller.extend("vsa.y5gl_pr_portal.view.BaseController", {
        ...
        success : function(oData, response) {
          if(oData.results.length > 0){
            if(oData.results[0].EAdm && oData.results[0].EAdm != ""){
              ...
              if (!t._oDialogAdm) {
                t._oDialogAdm = sap.ui.xmlfragment("vsa.y5gl_pr_portal.view.fragment.adm", t);
        ...
        oIconTabBar.bindAggregation("items", sPathToAprova, function(index, context) {
          ...
          return new sap.m.IconTabFilter({
            ...
            var fil = new sap.ui.model.Filter({ filters: [ new sap.ui.model.Filter("IUnidade", "EQ", context.getObject().Unidade),
                                     ...
                                     new sap.ui.model.Filter("IProcesso", "EQ", "PR"),
        ...
        ahFields.forEach(function(n) {
          ...
          if (sContext) {
            ...
            if(oField && oField.length > 0){
              ...
              if (n.Fieldname === "doc_mod") {

            	  var sLink = "sap/bc/gui/sap/its/webgui/its/webgui?~transaction=*ZT502PRCT";
            	  sLink += "+p_deta=X;";				  
            	  sLink += "s_doc-low=" + oField;
            	  ...
            	  oForm.addContent( new sap.m.Link({
            	  	text: oField,
            	  	href: sUrl,
            	  	target: "_blank"
            	  }));
      ...
      for(var i=0; i<aTab.length;i++){
        ...
        var oEntry = {
            ...
            //Motivo      : ((sRejectionText) ? sRejectionText : "")
              Motivo      : ((aTab[i].DocMod) ? aTab[i].DocMod : "")
        }
