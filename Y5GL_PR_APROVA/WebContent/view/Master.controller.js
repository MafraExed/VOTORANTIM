...
sap.ui.define([
  ...
  "vsa/y5gl_pr_portal/model/grouper",
  "vsa/y5gl_pr_portal/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, Formatter, grouper, GroupSortState) {
  "use strict";

  return BaseController.extend("vsa.y5gl_pr_portal.view.Master", {
...
//          }
    ...
    onSemanticFilterPress: function(){
         if (!this._oDialogApprove_S) {
           this._oDialogApprove_S = sap.ui.xmlfragment("AdvancedSearchDialog", "vsa.y5gl_pr_portal.view.fragment.advsearch", this);
...
onMultiSelectPress: function (e) {
  ...
  if(this.getRouter().oHashChanger.getHash().indexOf("mPr") != -1){
    this._showDetail(this._oList.getItems()[0]);
  }
  } else {
  this._oList.setMode('MultiSelect');
  ...
  if(!Device.system.phone){;
    ...
    onOpenViewSettings: function () {
      if (!this._oViewSettingsDialog) {
        this._oViewSettingsDialog = sap.ui.xmlfragment("vsa.y5gl_pr_portal.view.fragment.filter", this);
