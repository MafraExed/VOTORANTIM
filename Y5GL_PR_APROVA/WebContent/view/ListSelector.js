sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("vsa.y5gl_pr_portal.view.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias vsa.y5gl_pr_portal.controller.ListSelector
			 */
			 ...
			 * @return {vsa.y5gl_pr_portal.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
