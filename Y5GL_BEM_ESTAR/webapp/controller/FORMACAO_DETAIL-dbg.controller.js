sap.ui.define([
	...
	var Pernr;
	var Chamado;
	return BaseController.extend("Y5GL_BEM_ESTAR.Y5GL_BEM_ESTAR.controller.FORMACAO_DETAIL", {
		...
		onuploadComplete: function (oEvent) {
			...
			if (Subty !== "") {
				...
				oList.getBinding("items").filter([oFilterPenr,oFilterInfty, oFilterSubty, oFilterTipo, oFilterCham]);
			}
		},
