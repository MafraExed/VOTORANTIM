sap.ui.define([
	...
	return BaseController.extend("Y5GL_BEM_ESTAR.Y5GL_BEM_ESTAR.controller.DepententeDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Y5GL_BEM_ESTAR.Y5GL_BEM_ESTAR.view.DepententeDetail
		 */
		onInit: function () {
		...
		onuploadComplete: function (oEvent) {
			...
			if (Pernr !== "" && Subty !== "") {
				...
				oList.getBinding("items").filter([oFilterPernr, oFilterInfty, oFilterSubty, oFilterTipo, oFilterFavor, oFilterCpf, oFilterCham]);
			}
		},
		...
		onSave: function () {
			...
			var Cpf = this.getView().byId("idCpf").getValue();
			var Key = "/ZET_GLRH_DEPENDENTESSet(Pernr='" + Pernr + "',Subty='" + Subty + "',Objps='" + Objps + "',Favor='" + Favor +
				"',Tipo='C',Icnum='" + Cpf + "',Chamado='" + Chamado +"')";
			var oEntry = {};
